...
export var drawDayKLine = function(data, tName, lTitle, tipId, chartId, callback) {
    ...
    var showLastDayData = function() {
        ...
        volume = parseFloat(dailyData[tempPostion]['volume']).toFixed(0);
        ...
        reporting.innerHTML = '<ul style="list-style: none;margin: 0 auto;overflow: hidden;width: 100%;"><li style="float: left;width: 29%;"><p style="line-height:17px">' + lastDate + '</p><p><span style="background-color:#666666;">' + '' + '</span></p></li><li style="float: left;width: 23%;"><p>开盘:' + open + '</p><p>收盘:' + close + '</p></li><li style="float: left;width: 23%;"><p>最高:' + high + '</p><p>最低:' + low + '</p></li><li style="float: left;width: 25%;"><p>成交:' + volume + '</p><p>涨跌:' + zdf + '%</p></li></ul><p style="margin-top:4px"><span style="color:#E0E0E0;padding-right: 15px">MA5:' + MA5 + '</span><span style="color: #EEB13A;padding-right: 15px">MA10:' + MA10 + '   </span><span style="color:#B83A8B;padding-right: 15px">MA20:' + MA20 + '</span><span style="color:#47993D">MA60:' + MA60 + '</span></p>';
    };
    ...
    if(!firstDay){
        ...
        firstDay = new Date(firstDay.replace(/-/g, "/")).getTime();
        plotLineWidth = 1;
    }
            ...
            formatter: function() {
                ...
                for (var i = 0; i < dailyData.length; i++) {
                    if (this.x == dailyData[i]['time'] * 1000) {
                        ...
                        volume = parseFloat(dailyData[i]['volume']).toFixed(0);
                    }
                }
                try {
                    MA5 = this.points[0].y;
                ...
                reporting.innerHTML = '<ul style="list-style: none;margin: 0 auto;overflow: hidden;width: 100%;"><li style="float: left;width: 29%;"><p style="line-height:17px">' + Highcharts.dateFormat('%Y-%m-%d', this.x) + '</p><p><span style="background-color:#666666;">' + firstDayDesc + '</span></p></li><li style="float: left;width: 23%;"><p>开盘:' + open + '</p><p>收盘:' + close + '</p></li><li style="float: left;width: 23%;"><p>最高:' + high + '</p><p>最低:' + low + '</p></li><li style="float: left;width: 25%;"><p>成交:' + volume + '</p><p>涨跌:' + zdf + '%</p></li></ul><p style="margin-top:4px"><span style="color:#E0E0E0;padding-right: 15px">MA5:' + MA5 + '</span><span style="color: #EEB13A;padding-right: 15px">MA10:' + MA10 + '   </span><span style="color:#B83A8B;padding-right: 15px">MA20:' + MA20 + '</span><span style="color:#47993D">MA60:' + MA60 + '</span></p>';  
