    ...
    <div class="restContainer">
        ...
        <form class="restForm">
            <section class="input_container">
                <input type="password" placeholder="请输入新密码" name="passWord" v-model="passWord">
            </section>
            <section class="input_container">
...
export default {
    ...
    methods: {
            //确定
            okButton() {
                if (responsePassword(this.passWord) != '') {
                    this.showAlert = true;
                ...
                let handler = this;
                forgetResetPassword(this.mobile, this.passWord,this.token, function(ret) {
