    ...
    <div class="market_container">
        ...
        <section class="menu">
            ...
            <section class="menu-top">
                <div :class='{up:indexDetail.range >= 0,down:indexDetail.range <0}'>
                    <p><span class="title">{{indexDetail.total}}</span></p>
                    <p><span>{{indexDetail.range}}</span><span>{{indexDetail.percent}}</span></p>
                    <p>昨收 <span>{{indexDetail.preClose}}</span> &nbsp;&nbsp;&nbsp;&nbsp;今开 <span>{{indexDetail.nowOpen}}</span></p>
                    <div class="right" :class="{down:increase >= 0,up:increase <0}">
                        <p>昨收：<span v-cloak>{{indexDetail.preClose}}</span></p>
            ...
            <section class="menu-bottom">
                <div class="menu-type">
                    <ul>
                        ...
                        <li><span :class='{activity_k: changeMenuType =="percent"}' @click="changeMenuType='percent'">成份股</span></li>
                ...
                <transition name="fade-choose">
                    <section v-show="changeMenuType =='percent'" class="menu-container">
                        <p>成分股</p>
                    </section>
                </transition>
                <transition name="fade-choose">
...
export default {
    ...
    data() {
        return {
            changeMenuType: 'news', //切换菜单，新闻、成分股、关于
    ...
    methods: {
        ...
        async initChart(kType) {
            ...
            let result = {
                ...
                "ccode": "000002.sz",
                "tag": "mtag_s430101_金融科技",
                "cname": "寻宝图Ａ"
            };
            getChart(result, chartData);
