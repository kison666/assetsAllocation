<template>
    <div class="restContainer">
        ...
        <form class="restForm">
            ...
            <p class="title">恭喜您</p>
            <p class="title">申请已成功提交，1个工作日内将发送开户链接到您的邮箱。</p>
        </form>
        <div class="login_container" @click="nextButton()">确定</div>
        <p class="tip">万一您发现自己所填写的关键信息，如身份证和地址信息有错误，请联系我们客服处理：021-55889019。</p>
